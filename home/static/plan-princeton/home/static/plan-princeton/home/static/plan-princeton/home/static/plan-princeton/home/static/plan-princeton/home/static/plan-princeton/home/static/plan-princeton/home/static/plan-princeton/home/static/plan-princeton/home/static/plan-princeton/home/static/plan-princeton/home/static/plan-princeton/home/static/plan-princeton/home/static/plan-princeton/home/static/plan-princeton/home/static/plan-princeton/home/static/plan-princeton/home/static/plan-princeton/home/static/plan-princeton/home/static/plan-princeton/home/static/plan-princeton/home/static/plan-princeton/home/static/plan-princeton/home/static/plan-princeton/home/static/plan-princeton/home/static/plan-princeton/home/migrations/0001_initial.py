    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('x', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.Course')),
            ],
        ),
        migrations.CreateModel(
            name='Professor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_list', models.ManyToManyField(to='home.Course')),
                ('req_lists_inside', models.ManyToManyField(related_name='_req_list_req_lists_inside_+', to='home.Req_List')),
            ],
        ),
        migrations.CreateModel(
            name='URL',
